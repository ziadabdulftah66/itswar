            ...
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <h5 class="content-header-title float-left mb-0">إنشاء وثيقة </h5>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form form-vertical" action="{{route('photoType.store')}}" method="post">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="min_discription" class="form-control" name="min_discription">{{old('min_discription')}}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="discription" class="form-control" name="discription">{{old('discription')}}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number"  id="height" class="form-control" name="height" value="{{old('height')}}" >
                                                @error('height')
                                                <span class=" text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number"  id="width" class="form-control" name="width" value="{{old('width')}}" >
                                                @error('width')
                                                <span class=" text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number"  id="width" class="form-control" name="price" value="{{old('price')}}" >
                                                @error('price')
                                                <span class=" text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
